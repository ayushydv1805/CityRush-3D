  ...
  return (
    <main className="menu">
      ...
      <section className="hero">
        ...
        <p className="lead">Chandigarh is now a proper playground. Traffic moves, pedestrians walk, and three timed driving missions turn the first city slice into a real challenge. Hit every glowing checkpoint and finish the route before the clock reaches zero.</p>
      ...
      <footer><span>CHANDIGARH • REWARI • GURUGRAM • DELHI</span><span>v0.6 PHASE 6</span></footer>
    </main>
  );
}
